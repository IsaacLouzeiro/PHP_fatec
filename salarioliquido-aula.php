...
<body>
    ...
    <form method="post" action="calcular-salarioliquido.php">
        <label for="salario_bruto">Salário Bruto:</label><br>
        <input type="number" name="salario_bruto" step="0.01" required><br>
        <label for="descontos">Total de Descontos:</label><br>
        <input type="number" name="descontos" step="0.01" required><br>
